"""Config flow to configure Xiaomi/Viomi Washing Machine component."""
import logging
...
class XiaomiWashingMachinelowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a Xiaomi/Viomi Washing Machine config flow."""
